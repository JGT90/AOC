...
namespace AOC2021 {
    internal class Day23 : DayN {
        ...
        public override string Part1() {
            string[] lInput = System.IO.File.ReadAllLines(@"..\..\..\Inputs\Week23.txt");
            c_burrow burrow = new c_burrow(2);

            parse_input(@"..\..\..\Inputs\Week23.txt", burrow, false);

            List<c_burrow> solution_stack = new List<c_burrow>();

            (bool solved, int cost) = burrow.try_solve(false, solution_stack);
        ...
        public override string Part2() {
            string[] lInput = System.IO.File.ReadAllLines(@"..\..\..\Inputs\Week23.txt");
            c_burrow burrow = new c_burrow(4);

            parse_input(@"..\..\..\Inputs\Week23_2.txt", burrow, false);
