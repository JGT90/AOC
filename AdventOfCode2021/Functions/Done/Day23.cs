...
namespace AdventOfCode2021.Functions {
    public class Day23 : AdventOfCode.AdventOfCode {
        const string mPath = @"..\..\InputFiles\Input12_23_1.txt";
        const string mPath2 = @"..\..\InputFiles\Input12_23_3.txt";
        ...
        public override string DoPartA() {
            return Day_23_Worker(2, mPath, false);
        }

        public override string DoPartB() {
            return Day_23_Worker(4, mPath2, false);
        }
    }
