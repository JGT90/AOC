    ...
    class Program {
        static void Main(string[] args) {
            ...
            do {
                ...
                Console.WriteLine($"\t01 = Day01 - Sonar Sweep");
                Console.WriteLine($"\t02 = Day02 - Dive");
                Console.WriteLine($"\t03 = Day03 - Binary Diagnostic");
                Console.WriteLine($"\t04 = Day04 - Giant Squid");
                Console.WriteLine($"\t05 = Day05 - Hydrothermal Venture");
                Console.WriteLine($"\t06 = Day06 - Lanternfish");
                Console.WriteLine($"\t07 = Day07 - The Treachery of Whales");
                Console.WriteLine($"\t08 = Day08 - Seven Segment Search");
