using AdventOfCode2015.Functions;
using System;
...
namespace AdventOfCode2015 {
    class Program {
        static void Main(string[] args) {
            ...
            do {
                Console.WriteLine($"Hello to my implementation of AdventOfCode 2021");
                Console.WriteLine();
                Console.WriteLine($"Have a look and decide which you want to see");
                Console.WriteLine($"\t01 = Day01 - Not Quite Lisp");
                Console.WriteLine($"\t02 = Day02 - I Was Told There Would Be No Math");
                Console.WriteLine($"\t03 = Day03 - Perfectly Spherical Houses in a Vacuum");
                Console.WriteLine($"\t04 = Day04 - The Ideal Stocking Stuffer");
                Console.WriteLine($"\t05 = Day05 - Doesn't He Have Intern-Elves For This?");
                Console.WriteLine($"\t06 = Day06 - Probably a Fire Hazard");
                Console.WriteLine($"\t07 = Day07 - Some Assembly Required");
                Console.WriteLine($"\t08 = Day08 - Matchsticks");
                Console.WriteLine($"\t09 = Day09 - All in a Single Night");
